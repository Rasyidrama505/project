        ...
        <div class="row justify-content-center">
            <div class="col-md-3 mb-4">
                <div class="card menu-card text-center p-4">
                    ...
                    <a href="/disSLB" class="btn btn-outline-primary mt-2">Lihat Data</a>
                </div>
            </div>
            <div class="col-md-3 mb-4">
                <div class="card menu-card text-center p-4">
                    ...
                    <a href="/dasarSLB" class="btn btn-outline-primary mt-2">Lihat Data</a>
                </div>
            </div>
            <div class="col-md-3 mb-4">
                <div class="card menu-card text-center p-4">
                    ...
                    <a href="/drmSLB" class="btn btn-outline-primary mt-2">Lihat Data</a>
                </div>
            </div>
            <div class="col-md-3 mb-4">
                <div class="card menu-card text-center p-4">
                    ...
                    <a href="/gtkSLB" class="btn btn-outline-primary mt-2">Lihat Data</a>
                </div>
            </div>
        </div>
    </div>
