...
<div class="main-content p-4">
    ...
    <div class="dashboard-header d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h2 class="mb-0">Data Rekap GTK SMK Tahun 2025</h2>
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            @php
                $pns = $gtk_smk->sum('guru_pns');
                $gty = $gtk_smk->sum('guru_gty');
                $gtt = $gtk_smk->sum('guru_gtt');
                $p3k = $gtk_smk->sum('guru_p3k');
                $total_guru = $pns + $gty + $gtt + $p3k;

                $s1_s3 = $gtk_smk->sum('guru_s1_s3');
                $kurang_s1 = $gtk_smk->sum('guru_s1_lebih');

                $sertifikasi = $gtk_smk->sum('guru_sertifikasi');
                $belum_sertifikasi = $gtk_smk->sum('guru_belum_sertifikasi');
            @endphp
            <div class="row">
                <div class="col-md-4">
    ...
    <div class="table-responsive mt-4">
        <table class="table table-striped table-hover table-bordered">
            ...
            <tbody class="text-center align-middle">
                ...
                @empty
                <tr>
                    <td colspan="13" class="text-center">Tidak ada data GTK SMK</td>
                </tr>
                @endforelse
            </tbody>
        </table>
