...
<div class="main-content p-4">
    ...
    <div class="dashboard-header d-flex align-items-center mb-4">
        ...
        <div>
            <h2 class="mb-0">Menu Data SMK</h2>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card menu-card text-center h-100">
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <button class="btn btn-primary mt-auto" data-bs-toggle="modal" data-bs-target="#yearSelectionModal" data-title="Data Identitas Sekolah" data-url="/disSMK">
                        Lihat Data
                    </button>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card menu-card text-center h-100">
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <button class="btn btn-success mt-auto" data-bs-toggle="modal" data-bs-target="#yearSelectionModal" data-title="Data Sarpras" data-url="/dasarSMK">
                        Lihat Data
                    </button>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card menu-card text-center h-100">
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <button class="btn btn-warning mt-auto" data-bs-toggle="modal" data-bs-target="#yearSelectionModal" data-title="Data Rekap Murid" data-url="/drmSMK">
                        Lihat Data
                    </button>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card menu-card text-center h-100">
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <button class="btn btn-danger mt-auto" data-bs-toggle="modal" data-bs-target="#yearSelectionModal" data-title="Data Rekap GTK" data-url="/gtkSMK">
                        Lihat Data
                    </button>
                </div>
            </div>
...
<script>
    ...
    // Script untuk Modal Pilihan Tahun
