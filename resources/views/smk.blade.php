        ...
        <div class="row justify-content-center">
            <div class="col-md-3 mb-4">
                <div class="card menu-card text-center p-4">
                    ...
                    <a href="/disSMK" class="btn btn-outline-primary mt-2">Lihat Data</a>
                </div>
            </div>
            <div class="col-md-3 mb-4">
                <div class="card menu-card text-center p-4">
                    ...
                    <a href="/dasarSMK" class="btn btn-outline-primary mt-2">Lihat Data</a>
                </div>
            </div>
            <div class="col-md-3 mb-4">
                <div class="card menu-card text-center p-4">
                    ...
                    <a href="/drmSMK" class="btn btn-outline-primary mt-2">Lihat Data</a>
                </div>
            </div>
            <div class="col-md-3 mb-4">
                <div class="card menu-card text-center p-4">
                    ...
                    <a href="/gtkSMK" class="btn btn-outline-primary mt-2">Lihat Data</a>
                </div>
            </div>
        </div>
    </div>
