        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card menu-card text-center h-100">
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <button class="btn btn-primary mt-auto" data-bs-toggle="modal" data-bs-target="#yearSelectionModal" data-title="Data Identitas Sekolah" data-url="/disSMA">
                        Lihat Data
                    </button>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card menu-card text-center h-100">
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <button class="btn btn-success mt-auto" data-bs-toggle="modal" data-bs-target="#yearSelectionModal" data-title="Data Sarpras" data-url="/dasarSMA">
                        Lihat Data
                    </button>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card menu-card text-center h-100">
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <button class="btn btn-warning mt-auto" data-bs-toggle="modal" data-bs-target="#yearSelectionModal" data-title="Data Rekap Murid" data-url="/drmSMA">
                        Lihat Data
                    </button>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card menu-card text-center h-100">
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <button class="btn btn-danger mt-auto" data-bs-toggle="modal" data-bs-target="#yearSelectionModal" data-title="Data Rekap GTK" data-url="/gtkSMA">
                        Lihat Data
                    </button>
                </div>
            </div>
...
<script>
    ...
    function generateDynamicUrl(url, year) {
        if (year == '2020') {
            return url; // Untuk tahun 2020, gunakan URL dasar (contoh: /disSMA)
        } else {
            // Untuk tahun lain, ambil 2 digit terakhir dan tambahkan ke URL
            const yearSuffix = year.toString().slice(-2); // '2021' -> '21'
            return url + yearSuffix; // contoh: /disSMA21
        }
    }
